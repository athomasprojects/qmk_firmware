...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT( /* Base */
        ...
        OSM(MOD_LSFT), KC_NUBS,          MT(MOD_LCTL, KC_Z), MT(MOD_CSHF, KC_X), KC_C,               KC_V, MT(MOD_LGUI, KC_B), KC_B,               KC_N,    KC_M,  KC_COMM, KC_DOT,                KC_SLSH, OSM(MOD_RSFT), KC_UP,
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, MS_WHLD, MS_UP,   MS_WHLU, _______, _______, _______, _______,  _______, KC_PSCR, _______, _______, TG(_GAMING),          _______,
    ...
    [_GAMING] = LAYOUT( /* Base */
        ...
        KC_LCTL,                   KC_LALT, KC_SPC,           KC_LGUI, KC_SPC,                   KC_RALT, TO(_QWERTY),        KC_LEFT, KC_DOWN, KC_RGHT),
