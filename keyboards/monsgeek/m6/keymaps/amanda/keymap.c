...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT( /* Base */
        ...
        KC_ESC,        MT(MOD_CA, KC_A), KC_S,               KC_D,               MT(MOD_LALT, KC_F), KC_G, KC_H, MT(MOD_LALT, KC_J), LT(_POG, KC_K), KC_L,    KC_SCLN, KC_QUOT, KC_NUHS,       KC_ENT,  KC_PGDN,
        ...
        MT(MOD_SUPCSH, KC_CAPS), KC_LALT, KC_LGUI, KC_LCTL,                                                      KC_SPC, KC_RWIN, TT(_FN), KC_LEFT, KC_DOWN, KC_RGHT),
